...
{
    public partial class NewAuto : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    normhourss.Visible = false;
                    NormhUpdate.Visible = false;
                    coursvalues.Visible = false;
                    coursvaluesup.Visible = false;
                    aktstr.Visible = false;
                    aktvrab.Visible = false;
                    summnorm.Visible = false;
                    summzap.Visible = false;
                    for (int i = 0; i < 5; i++)
                    {
                        zchnew.Rows[i].Cells[2].Visible = false;
                        zchnew.Rows[i].Cells[5].Visible = false;
                    }
                }
            }
            ...
            if (!Page.IsPostBack)
            {
                using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["autorepConnectionString"].ConnectionString))
                {
                    using (SqlCommand cmd = new SqlCommand())
                    {
                        ...
                        cmd.Connection = conn;
                        //
                        cmd.CommandText = "SELECT * FROM Settings where id=2";
                        conn.Open();
                        using (SqlDataReader sdr = cmd.ExecuteReader())
                        {
                            while (sdr.Read())
                            {
                                coursvalues.Text = sdr["Value"].ToString();
                            }
                        }
                        conn.Close();
                    }
                    ...
                    using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["autorepConnectionString"].ConnectionString))
                    {
                        using (SqlCommand cmd = new SqlCommand())
                        {
                            ...
                            using (SqlDataReader sdr = cmd.ExecuteReader())
                            {
                                while (sdr.Read())
                                {
                                    ((TextBox)part1.FindControl("Zrab" + t.ToString())).Text = sdr["Name"].ToString();
                                    t++;
                                }
                            }
                            conn.Close();
                            ...
                            using (SqlDataReader sdr = cmd.ExecuteReader())
                            {
                                while (sdr.Read())
                                {
                                    ((TextBox)part1.FindControl("Vrab" + t.ToString())).Text = sdr["Name"].ToString();
                                    t++;
                                }
                            }
                            conn.Close();
                            ...
                            using (SqlDataReader sdr = cmd.ExecuteReader())
                            {
                                while (sdr.Read())
                                {
                                    ...
                                    ((TextBox)part2.FindControl("zch" + t.ToString())).Text = s;
                                    ((TextBox)part2.FindControl("zapvlsp3" + t.ToString())).Text = s;
                                    t++;
                                }
                            }
                            conn.Close();
                            ...
                            using (SqlDataReader sdr = cmd.ExecuteReader())
                            {
                                while (sdr.Read())
                                {
                                    ((TextBox)part2.FindControl("zchnew" + t.ToString())).Text = sdr["Zapauto"].ToString();
                                    ((Label)part2.FindControl("zchnew" + t.ToString()+ "date")).Text = sdr["DataDob"].ToString();
                                    string temp;
                                    temp = sdr["Cena"].ToString();
                                    ((TextBox)part2.FindControl("zchnewval" + t.ToString())).Text = temp;
                            ...
                            using (SqlDataReader sdr = cmd.ExecuteReader())
                            {
                                while (sdr.Read())
                                {
                                    ((TextBox)part4.FindControl("SPrabName" + t.ToString())).Text = sdr["Name"].ToString();
                                    ((TextBox)part4.FindControl("SPrabNorm" + t.ToString())).Text = sdr["Norm"].ToString();
                                    ((TextBox)part4.FindControl("SPrabPrice" + t.ToString())).Text = sdr["Price"].ToString();
                                    t++;
                                }
                            }
                            conn.Close();
                            ...
                            using (SqlDataReader sdr = cmd.ExecuteReader())
                            {
                                while (sdr.Read())
                                {
                                    ((TextBox)part4.FindControl("SPzapName" + t.ToString())).Text = sdr["Name"].ToString();
                                    ((DropDownList)part4.FindControl("SPzapED" + t.ToString())).Text = sdr["ed"].ToString();
                                    ((TextBox)part4.FindControl("SPzapCount" + t.ToString())).Text = sdr["Count"].ToString();
                                    ((TextBox)part4.FindControl("SPzapSost" + t.ToString())).Text = sdr["Sost"].ToString();
                                    t++;
                                }
                            }
                            conn.Close();
                            ...
                            using (SqlDataReader sdr = cmd.ExecuteReader())
                            {
                                while (sdr.Read())
                                {
                                    ...
                                    ((TextBox)part2.FindControl("Zamechanie" + t.ToString())).Text = sdr["Zamech"].ToString();
                                        ...
                                        using (SqlCommand cmd1 = new SqlCommand())
                                        {
                                            ...
                                            using (SqlDataReader sdr1 = cmd1.ExecuteReader())
                                            {
                                                while (sdr1.Read())
                                                {
                                                    ...
                                                    ((DropDownList)part2.FindControl("isp" + t.ToString())).SelectedValue = vvv;
                                                }
                                            }
                                            conn1.Close();
                                        }
                                    }
                                    ((TextBox)part2.FindControl("rab" + t.ToString())).Text = sdr["Name"].ToString();
                                    string temp = "";
                                    temp = sdr["Time"].ToString();
                                    summr += float.Parse(temp);
                                    for (int l = 0; l < temp.Length - 1; l++)
                                        ((TextBox)part2.FindControl("rabval" + t.ToString())).Text += temp[l];
                                    ((TextBox)part2.FindControl("rabval1" + t.ToString())).Text += temp[temp.Length - 1];
                                    if (t > 1)
                                    {
                            ...
                            conn.Close();
                            summnorm.Text += " " + summr * float.Parse(coursvalues.Text);
                            summzap.Text += " " + summz;
                        }
        ...
        void AddNewRow(int i)
        {
            ...
            else
            {
                ...
                drop.Width = 170;
                drop.Height = 20;
                drop.Items.Add("Жарин");
                drop.Items.Add("Каешко");
                drop.Items.Add("Машков");
                drop.Items.Add("Махунов");
                drop.Items.Add("Задорожный");
                drop.Items.Add("Точиленко");
                drop.Items.Add("Габрусев");
               // Cell1.Controls.Add(new DropDownList { ID = "isp" + i, Width = 170, Height = 7 });
                Cell1.Controls.Add(drop);
                if (i >= 2)
                {
                    var Text1 = new TextBox { ID = "rab" + i, Height = 7, Width = 350 };
                    Text1.TextChanged += Button1_Click;
                    Cell2.Controls.Add(Text1);
                }
                else Cell2.Controls.Add(new TextBox { ID = "rab" + i, Height = 7, Width = 350 });
                Cell3.Controls.Add(new TextBox { ID = "rabval" + i, Height = 7, Width = 35 });
                Cell4.Controls.Add(new TextBox { ID = "rabval1" + i, Height = 7, Width = 35 });
                row.Cells.Add(Cell1);
                row.Cells.Add(Cell2);
                row.Cells.Add(Cell3);
                row.Cells.Add(Cell4);
        ...
        void AddNewRow1(int i)
        {
            ...
            {
                Cell1.Controls.Add(new TextBox { ID = "Zamechanie" + i, Width = 350 });
...
//
        ...
        protected void newautoIns_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["autorepConnectionString"].ConnectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    for (int i = 1; i < 11; i++)
                    {
                        if (!String.IsNullOrEmpty(((TextBox)part2.FindControl("zchnew" + i.ToString())).Text))
                        {
                            cmd.CommandText = "INSERT INTO [autorep].[dbo].[zapauto] ([id],[Zapauto],[Cena],[DataDob]) VALUES (" + (idzapm + 1) + ",'" + ((TextBox)part2.FindControl("zchnew" + i.ToString())).Text + "'," + ((TextBox)part2.FindControl("zchnewval" + i.ToString())).Text.Replace(',', '.') + ",GETDATE())";
                            conn.Open();
                            cmd.ExecuteNonQuery();
                            conn.Close();
                        }
                    ...
                    for (int i = 1; i < 9; i++)
                    {
                        if (!String.IsNullOrEmpty(((TextBox)part3.FindControl("zapvlsp3" + i.ToString())).Text))
                        {
                            cmd.CommandText = "INSERT INTO [autorep].[dbo].[zapvl] ([id],[Zapvl]) VALUES (" + (idzapvl + 1) + ",'" + ((TextBox)part3.FindControl("zapvlsp3" + i.ToString())).Text + "')";
                            conn.Open();
                            cmd.ExecuteNonQuery();
                            conn.Close();
                        }
                    ...
                    {
                        if (!String.IsNullOrEmpty(((TextBox)part2.FindControl("Zamechanie" + i.ToString())).Text))
                        {
                            int sq=0;
                            if (((CheckBox)part2.FindControl("ZamecSot" + i.ToString())).Checked == true) sq = 1;
                            cmd.CommandText = "INSERT INTO Zamechht ([id],[Zamech],[Tipe],[Sost],[DataDob]) VALUES (" + (idzamecc + 1) + ",'" + ((TextBox)part2.FindControl("Zamechanie" + i.ToString())).Text + "','" + ((Label)part2.FindControl("Tipe" + i.ToString())).Text + "',"+sq+",GETDATE())";
                            conn.Open();
                            cmd.ExecuteNonQuery();
                            conn.Close();
                        }
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        if (!String.IsNullOrEmpty(((TextBox)part1.FindControl("Zrab" + i.ToString())).Text))
                        {
                            cmd.CommandText = "INSERT INTO [autorep].[dbo].[zayavlr] ([id],[Name]) VALUES (" + (idzayavlr + 1) + ",'" + ((TextBox)part1.FindControl("Zrab" + i.ToString())).Text + "')";
                            conn.Open();
                            cmd.ExecuteNonQuery();
                            conn.Close();
                        }
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        if (!String.IsNullOrEmpty(((TextBox)part1.FindControl("Vrab" + i.ToString())).Text))
                        {
                            cmd.CommandText = "INSERT INTO [autorep].[dbo].[rabkvip] ([id],[Name]) VALUES (" + (idkvip + 1) + ",'" + ((TextBox)part1.FindControl("Vrab" + i.ToString())).Text + "')";
                            conn.Open();
                            cmd.ExecuteNonQuery();
                            conn.Close();
                        }
                    ...
                    {
                        if (!String.IsNullOrEmpty(((TextBox)part2.FindControl("rab" + i.ToString())).Text))
                        {
                            cmd.CommandText = "INSERT INTO [raboti] ([id],[Name],[Vipolnil],[Time],[DataDob],[Dobavil]) VALUES (" + (idviprab + 1) + ",'" + ((TextBox)part2.FindControl("rab" + i.ToString())).Text + "', convert(bigint, (SELECT id from sotrudniki where Sotrudnik='" + ((DropDownList)part2.FindControl("isp" + i.ToString())).SelectedValue + "'))," + (((TextBox)part2.FindControl("rabval" + i.ToString())).Text.Replace(',', '.') + ((TextBox)part2.FindControl("rabval1" + i.ToString())).Text.Replace(',', '.')) + ", GETDATE(),'" + User.Identity.Name.ToString() + "')";
                            conn.Open();
                            cmd.ExecuteNonQuery();
                            conn.Close();
                        }
                    ...
                    for (int i = 1; i < 7; i++)
                    {
                        if (!String.IsNullOrEmpty(((TextBox)part4.FindControl("SPrabName" + i.ToString())).Text))
                        {
                            cmd.CommandText = "INSERT INTO [autorep].[dbo].[SPrabot] ([id],[Name],[Norm],[Price]) VALUES (" + (idsprab + 1) + ",'" + ((TextBox)part4.FindControl("SPrabName" + i.ToString())).Text + "','" + ((TextBox)part4.FindControl("SPrabNorm" + i.ToString())).Text.Replace(',', '.') + "'," + ((TextBox)part4.FindControl("SPrabPrice" + i.ToString())).Text.Replace(',', '.') + ")";
                            conn.Open();
                            cmd.ExecuteNonQuery();
                            conn.Close();
                        }
                    ...
                    for (int i = 1; i < 7; i++)
                    {
                        if (!String.IsNullOrEmpty(((TextBox)part4.FindControl("SPzapName" + i.ToString())).Text))
                        {
                            cmd.CommandText = "INSERT INTO [autorep].[dbo].[SPzap] ([id],[Name],[ed],[Count],[Sost]) VALUES (" + (idspzap + 1) + ",'" + ((TextBox)part4.FindControl("SPzapName" + i.ToString())).Text + "','" + ((DropDownList)part4.FindControl("SPzapED" + i.ToString())).Text + "'," + ((TextBox)part4.FindControl("SPzapCount" + i.ToString())).Text + ",'" + ((TextBox)part4.FindControl("SPzapSost" + i.ToString())).Text + "')";
                            conn.Open();
                            cmd.ExecuteNonQuery();
                            conn.Close();
                        }
                    ...
                    if (Request.Params["paramstoreq"] != null)
                    {
                        ...
                        for (int i = 1; i < 11; i++)
                        {
                            if (!String.IsNullOrEmpty(((TextBox)part2.FindControl("zchnew" + i.ToString())).Text))
                            {
                                ...
                                cmd.CommandText = "INSERT INTO [autorep].[dbo].[zapauto] ([id],[Zapauto],[Cena],[DataDob]) VALUES (" + (idzapm) + ",'" + ((TextBox)part2.FindControl("zchnew" + i.ToString())).Text + "'," + ((TextBox)part2.FindControl("zchnewval" + i.ToString())).Text.Replace(',', '.') + ","+date+")";
                                conn.Open();
                                cmd.ExecuteNonQuery();
                                conn.Close();
                            }
                        ...
                        for (int i = 1; i < 9; i++)
                        {
                            if (!String.IsNullOrEmpty(((TextBox)part3.FindControl("zapvlsp3" + i.ToString())).Text))
                            {
                                ...
                                cmd.CommandText = "INSERT INTO [autorep].[dbo].[zapvl] ([id],[Zapvl]) VALUES (" + (idzapvl) + ",'" + ((TextBox)part3.FindControl("zapvlsp3" + i.ToString())).Text + "')";
                                conn.Open();
                                cmd.ExecuteNonQuery();
                                conn.Close();
                            }
                        ...
                        for (int i = 1; i < addedRowsCount1; i++)
                        {
                            if (!String.IsNullOrEmpty(((TextBox)part2.FindControl("Zamechanie" + i.ToString())).Text))
                            {
                                ...
                                cmd.CommandText = "INSERT INTO Zamechht ([id],[Zamech],[Tipe],[Sost],[DataDob]) VALUES (" + (idzamecc) + ",'" + ((TextBox)part2.FindControl("Zamechanie" + i.ToString())).Text + "','" + ((Label)part2.FindControl("Tipe" + i.ToString())).Text + "'," + sq + ", " + date + ")";
                                conn.Open();
                                cmd.ExecuteNonQuery();
                                conn.Close();
                            }
                        ...
                        for (int i = 0; i < 10; i++)
                        {
                            if (!String.IsNullOrEmpty(((TextBox)part1.FindControl("Zrab" + i.ToString())).Text))
                            {
                                cmd.CommandText = "INSERT INTO [autorep].[dbo].[zayavlr] ([id],[Name]) VALUES (" + (idzayavlr) + ",'" + ((TextBox)part1.FindControl("Zrab" + i.ToString())).Text + "')";
                                conn.Open();
                                cmd.ExecuteNonQuery();
                                conn.Close();
                            }
                        ...
                        for (int i = 0; i < 10; i++)
                        {
                            if (!String.IsNullOrEmpty(((TextBox)part1.FindControl("Vrab" + i.ToString())).Text))
                            {
                                cmd.CommandText = "INSERT INTO [autorep].[dbo].[rabkvip] ([id],[Name]) VALUES (" + (idkvip) + ",'" + ((TextBox)part1.FindControl("Vrab" + i.ToString())).Text + "')";
                                conn.Open();
                                cmd.ExecuteNonQuery();
                                conn.Close();
                            }
                        ...
                        for (int i = 1; i < addedRowsCount; i++)
                        {
                            if (!String.IsNullOrEmpty(((TextBox)part2.FindControl("rab" + i.ToString())).Text))
                            {
                                if (String.IsNullOrEmpty(((TextBox)part2.FindControl("rabval" + i.ToString())).Text + ((TextBox)part2.FindControl("rabval1" + i.ToString())).Text)) ((TextBox)part2.FindControl("rabval" + i.ToString())).Text = "0";
                                cmd.CommandText = "INSERT INTO [raboti] ([id],[Name],[Vipolnil],[Time],[DataDob],[Dobavil]) VALUES (" + (idviprab) + ",'" + ((TextBox)part2.FindControl("rab" + i.ToString())).Text + "', convert(bigint, (SELECT id from sotrudniki where Sotrudnik='" + ((DropDownList)part2.FindControl("isp" + i.ToString())).SelectedValue + "'))," + (((TextBox)part2.FindControl("rabval" + i.ToString())).Text.Replace(',', '.') + ((TextBox)part2.FindControl("rabval1" + i.ToString())).Text.Replace(',', '.')) + ", GETDATE(),'" + User.Identity.Name.ToString() + "')";
                                conn.Open();
                                cmd.ExecuteNonQuery();
                                conn.Close();
                            }
                        ...
                        for (int i = 1; i < 7; i++)
                        {
                            if (!String.IsNullOrEmpty(((TextBox)part4.FindControl("SPrabName" + i.ToString())).Text))
                            {
                                cmd.CommandText = "INSERT INTO [autorep].[dbo].[SPrabot] ([id],[Name],[Norm],[Price]) VALUES (" + (idsprab) + ",'" + ((TextBox)part4.FindControl("SPrabName" + i.ToString())).Text + "','" + ((TextBox)part4.FindControl("SPrabNorm" + i.ToString())).Text.Replace(',', '.') + "'," + ((TextBox)part4.FindControl("SPrabPrice" + i.ToString())).Text.Replace(',', '.') + ")";
                                conn.Open();
                                cmd.ExecuteNonQuery();
                                conn.Close();
                            }
                        ...
                        for (int i = 1; i < 7; i++)
                        {
                            if (!String.IsNullOrEmpty(((TextBox)part4.FindControl("SPzapName" + i.ToString())).Text))
                            {
                                cmd.CommandText = "INSERT INTO [autorep].[dbo].[SPzap] ([id],[Name],[ed],[Count],[Sost]) VALUES (" + (idspzap) + ",'" + ((TextBox)part4.FindControl("SPzapName" + i.ToString())).Text + "','" + ((DropDownList)part4.FindControl("SPzapED" + i.ToString())).Text + "'," + ((TextBox)part4.FindControl("SPzapCount" + i.ToString())).Text + ",'" + ((TextBox)part4.FindControl("SPzapSost" + i.ToString())).Text + "')";
                                conn.Open();
                                cmd.ExecuteNonQuery();
                                conn.Close();
                            }
        ...
        protected void addZamec_Click(object sender, EventArgs e)
        {
            ...
            ((TextBox)part2.FindControl("Zamechanie" + addedRowsCount1.ToString())).Text = zamecc.Text;
            zamecc.Text = "";
            addedRowsCount1++;
            newautoSave_Click(this, e);
        }
        ...
        {
            float numb;
            if(float.TryParse(((TextBox)part4.FindControl("SPrabNorm1")).Text,out numb))
                ((TextBox)part4.FindControl("SPrabPrice1")).Text = (float.Parse(normhourss.Text) * float.Parse(((TextBox)part4.FindControl("SPrabNorm1")).Text)).ToString();
            SPrabPrice_TextChanged(this, e);
        }
        ...
        {
            float numb;
            if (float.TryParse(((TextBox)part4.FindControl("SPrabNorm2")).Text, out numb))
            ((TextBox)part4.FindControl("SPrabPrice2")).Text = (float.Parse(normhourss.Text) * float.Parse(((TextBox)part4.FindControl("SPrabNorm2")).Text)).ToString();
            SPrabPrice_TextChanged(this, e);
        }
        ...
        {
            float numb;
            if (float.TryParse(((TextBox)part4.FindControl("SPrabNorm3")).Text, out numb))
                ((TextBox)part4.FindControl("SPrabPrice3")).Text = (float.Parse(normhourss.Text) * float.Parse(((TextBox)part4.FindControl("SPrabNorm3")).Text)).ToString();
            SPrabPrice_TextChanged(this, e);
        }
        ...
        {
            float numb;
            if (float.TryParse(((TextBox)part4.FindControl("SPrabNorm4")).Text, out numb))
                ((TextBox)part4.FindControl("SPrabPrice4")).Text = (float.Parse(normhourss.Text) * float.Parse(((TextBox)part4.FindControl("SPrabNorm4")).Text)).ToString();
            SPrabPrice_TextChanged(this, e);
        }
        ...
        {
            float numb;
            if (float.TryParse(((TextBox)part4.FindControl("SPrabNorm5")).Text, out numb))
                ((TextBox)part4.FindControl("SPrabPrice5")).Text = (float.Parse(normhourss.Text) * float.Parse(((TextBox)part4.FindControl("SPrabNorm5")).Text)).ToString();
            SPrabPrice_TextChanged(this, e);
        }
        ...
        {
            float numb;
            if (float.TryParse(((TextBox)part4.FindControl("SPrabNorm6")).Text, out numb))
                ((TextBox)part4.FindControl("SPrabPrice6")).Text = (float.Parse(normhourss.Text) * float.Parse(((TextBox)part4.FindControl("SPrabNorm6")).Text)).ToString();
            SPrabPrice_TextChanged(this, e);
        }
        ...
        protected void SPrabPrice_TextChanged(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < 7; i++)
            {
                if (!String.IsNullOrEmpty(((TextBox)part4.FindControl("SPrabPrice" + i.ToString())).Text))
                {
                    summ += float.Parse(((TextBox)part4.FindControl("SPrabPrice" + i.ToString())).Text);
                }
            }

            ((TextBox)part4.FindControl("SPrabPriceItog")).Text = summ.ToString();
            if (!String.IsNullOrEmpty(SPrabPriceItog.Text))
            {
                float it = float.Parse(SPrabPriceItog.Text);
                string sss = Converter.RuDateAndMoneyConverter.CurrencyToTxt(it, false);
        ...
        protected void coursvaluesup_Click(object sender, EventArgs e)
        {
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["autorepConnectionString"].ConnectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.Connection = conn;
                    cmd.CommandText = "UPDATE Settings SET Value = '" + coursvalues.Text + "' WHERE id =2";
                    conn.Open();
                    cmd.ExecuteNonQuery();
                    conn.Close();
                }
